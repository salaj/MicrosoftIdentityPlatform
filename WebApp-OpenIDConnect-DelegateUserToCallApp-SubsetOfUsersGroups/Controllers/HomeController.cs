...
using WebApp_OpenIDConnect_DelegateUserToCallApp_SubsetOfUsers_Groups.Models;

namespace WebApp_OpenIDConnect_DelegateUserToCallApp_SubsetOfUsers_Groups.Controllers
{
    [Authorize]
    public class HomeController : Controller
    {
        ...
        [Authorize(Policy = AuthorizationPolicies.AssignmentToGroupPresenceRequired)]
